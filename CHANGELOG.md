...
Everything below landed after `1.2.0+4` (the last version bump, part of the Android 16 target SDK compliance fix) and hasn't been given its own version number yet.
